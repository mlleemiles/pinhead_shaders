// indirect specular apply
// ---- Created with 3Dmigoto v1.3.16 on Wed Sep 27 12:42:37 2023
  ...
  out float3 o0 : SV_TARGET0)
{
  ...
  r2.yz = float2(384,384) * abs(r2.yz);
  r2.yz = r2.yz / r2.xx;
  r2.yz = min(float2(1,1), r2.yz);
  r2.yz = float2(1,1) + -r2.yz;
  r3.xyzw = cmp(r1.yzyz < float4(0,0,0,0));
  r3.xyzw = r3.xyzw ? float4(0.00130200002,0.00130200002,-0.00130200002,-0.00130200002) : float4(-0.00130200002,-0.00130200002,0.00130200002,0.00130200002);
